...
class ManagerController extends AppController {
	...
	public function display($cachable = false, $urlparams = false) {
		...
		JToolBar::getInstance('toolbar')->appendButton('Popup', 'warning', 'Check For Modifications', JRoute::_(JUri::root() . 'administrator/index.php?option='.$this->app->component->self->name.'&controller='.$this->controller.'&task=checkmodifications&tmpl=component', true, 2), 570, 350);
		JToolBar::getInstance('toolbar')->appendButton('Popup', 'checkmark', 'Check Requirements', JRoute::_(JUri::root() . 'administrator/index.php?option='.$this->app->component->self->name.'&controller='.$this->controller.'&task=checkrequirements&tmpl=component', true, 2), 570, 350);
	...
	public function doExport() {
		...
		$files = array_map(function ($file) use ($read_directory) { return $read_directory.$file; }, $files);
